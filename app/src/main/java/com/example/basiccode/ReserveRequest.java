...
public class ReserveRequest extends StringRequest {
    ...
    // 서버 URL 설정 ( PHP 파일 연동 )
    final static private String URL = "http://192.168.0.10/Reserve.php";
    final static private String URL2 = "http://192.168.0.10/Reserve_college.php";
    final static private String URL3 = "http://192.168.0.10/Reserve_area.php";
