...
public class MypageRequest extends StringRequest {
    ...
    // 서버 URL 설정 ( PHP 파일 연동 )
    final static private String URL = "http://172.30.1.46/mypage.php";
    final static private String URL2 = "http://172.30.1.46/mycharge.php";
    final static private String URL3 = "http://172.30.1.46/car.php";
    final static private String URL4 = "http://172.30.1.46/myreserve.php";
